							...
							<div class="card-body">
                                ...
                                <?= isset($input->id) ? form_hidden('id', $input->id) : '' ?>
									...
									<div class="form-group">
										...
										<?= form_textarea(['name' => 'description', 'value' => $input->description, 'row' => 4, 'class' => 'form-control', 'placeholder' => 'Detail Description']) ?>
									...
									<div class="form-group">
										...
										<img src="<?= base_url("/images/detail/$input->image") ?>" alt="" height="150">
										<?php endif ?>
										<?= form_error('image') ?>
									</div>
