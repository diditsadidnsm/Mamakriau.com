            <div class="page-content">
				<nav class="page-breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="<?= base_url('administrator/banner') ?>">Banner Brief</a></li>
						<li class="breadcrumb-item active" aria-current="page">Create Banner Home Brief</li>
					</ol>
				</nav>
				<div class="row">
							...
							<div class="card-body">
                                ...
                                <?= isset($input->id) ? form_hidden('id', $input->id) : '' ?>
									...
									<div class="form-group">
										...
										<img src="<?= base_url("/images/brief/$input->image") ?>" alt="" height="150">
										<?php endif ?>
										<?= form_error('image') ?>
									</div>
