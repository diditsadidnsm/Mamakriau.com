...
<head>
    ...
    <link href="<?= base_url() ?>assets/member/assets/css/users/user-profile.css" rel="stylesheet" type="text/css" />
                        ...
                        <div class="user-profile layout-spacing">
                            <div class="widget-content widget-content-area">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <a href="<?= base_url("/member/profile/update/$content->token") ?>" class="mt-2 edit-profile"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3"><path d="M12 20h9"></path><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path></svg></a>
                                </div>
                                <div class="text-center user-info">
                                    <img src="<?= base_url() ?>images/user/<?= $content->image ?>" alt="<?= $content->username ?>" style="width: 120px;">
                                    ...
                                    <div class="">
                                        <ul class="contacts-block list-unstyled">
                                            <li class="contacts-block__item">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-coffee"><path d="M18 8h1a4 4 0 0 1 0 8h-1"></path><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"></path><line x1="6" y1="1" x2="6" y2="4"></line><line x1="10" y1="1" x2="10" y2="4"></line><line x1="14" y1="1" x2="14" y2="4"></line></svg> <?= $content->username ?>
                                            </li>
                                            <li class="contacts-block__item">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg><?= $content->website ?>
                                            </li>
                                            <li class="contacts-block__item">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-map-pin"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg><?= $content->country ?>
                                            </li>
                                            <li class="contacts-block__item">
                                                <a href="mailto:<?= $content->email ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg><?= $content->email ?></a>
                                            </li>
                                            <li class="contacts-block__item">
                                                ...
                                                <ul class="list-inline">
                                                    <li class="list-inline-item">
                                                        <div class="social-icon">
                                                            <a href="<?= $content->url_facebook ?>" target="_blank">
                                                    ...
                                                    <li class="list-inline-item">
                                                        <div class="social-icon">
                                                            <a href="<?= $content->url_twitter ?>" target="_blank">
                                                    ...
                                                    <li class="list-inline-item">
                                                        <div class="social-icon">
                                                            <a href="<?= $content->url_linkedin ?>" target="_blank">
                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <div class="bio-skill-box">
                                    ...
                                    <div class="row">
                                        ...
                                        <?php foreach ($history as $pending) : ?>
                                        ...
                                        <div class="col-12 col-xl-6 col-lg-12 mb-xl-5 mb-5 ">
                                            ...
                                            <div class="d-flex b-skills">
                                                ...
                                                <div class="">
                                                    <?= $pending->is_status ? '<span class="badge badge-danger">Pending</span></h5>' : '<span class="badge badge-success">Fisnished</span></h5>'  ?>
                                                    <br/><br/>
                                                    <a href="<?= base_url("member/project/summary/$pending->url") ?>">
                                                        <h5><?= $pending->project_name ?>
                                                    </a>
                                                    <hr style="color: white;"/>
                                                    <p>Price: $1.000 </p>
                                                    <p>Category: Brand &amp; Identity </p>
                                                    <p>Date Started: 15 Agustus 2021 </p>
                                                    <p>Date Finished: 18 Agustus 2021 </p>
                                                </div>
                                            </div>
