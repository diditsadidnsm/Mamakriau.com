            ...
            <div class="layout-px-spacing">
                ...
                <div class="account-settings-container layout-top-spacing">
                    ...
                    <?= form_open_multipart($form_action, ['method' => 'POST']) ?>
                     ...
                     <input type="hidden" name="price" value="921.5">
                     <input type="hidden" name="discount" value="0.35">
                     <input type="hidden" name="storage" value="Brand Guide">
                        ...
                        <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                            <div class="row">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                                    <div id="about" class="section about">
                                        <div class="info">
                                            <h5 class="">All You Need for Brand</h5>
                                            <div class="row">
                                                <div class="col-lg-11 mx-auto">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 col layout-spacing">
                                                            ...
                                                            <h5>
                                                                <input class="form-check-input" type="checkbox" name="all_you_need" value="135"> Brand Guide - $135 &nbsp; 
