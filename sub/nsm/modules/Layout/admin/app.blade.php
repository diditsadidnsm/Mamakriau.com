...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard'}} - {{setting_item('site_title') ?? 'NSM LAB'}}</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; {{__('Mroom Indonesia by')}} <a href="{{__('https://mamakriau.com')}}" target="_blank">{{__('NSM LAB')}}</a>
                    </div>
                    <div class="col-md-6">
                        <div class="text-md-right footer-links d-none d-sm-block">
                            <a href="{{__('https://mamakriau.com/about')}}" target="_blank">{{__('About Us')}}</a>
                            <a href="{{__('https://mamakriau.com/contact')}}" target="_blank">{{__('Contact Us')}}</a>
                        </div>
                    </div>
                </div>
            </div>
